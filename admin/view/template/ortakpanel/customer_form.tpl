...
<div id="content">
  ...
  siparis_sitesi  = '<?php echo $_GET['siparis_sitesi'];?>'
$('select[name=\'customer_group_id\']').on('change', function() {
    $.ajax({
		url: 'index.php?route=ortakpanel/customer/customfield&siparis_sitesi='+siparis_sitesi+'&token=<?php echo $token; ?>&customer_group_id=' + this.value,
		dataType: 'json',
