<?php
class ControllerOrtakpanelApi extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->load->model('ortakpanel/api');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_ortakpanel_api->addApi($this->request->post);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_ortakpanel_api->editApi($this->request->get['api_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $api_id) {
				$this->model_ortakpanel_api->deleteApi($api_id);
			}
	...
	protected function getList() {
		...
		$user_total = $this->model_ortakpanel_api->getTotalApis();

		$results = $this->model_ortakpanel_api->getApis($filter_data);
	...
	protected function getForm() {
		...
		if (isset($this->request->get['api_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$api_info = $this->model_ortakpanel_api->getApi($this->request->get['api_id']);
		}
		...
		if (isset($this->request->post['api_ip'])) {
			...
			$data['api_ips'] = $this->model_ortakpanel_api->getApiIps($this->request->get['api_id']);
		} else {
			$data['api_ips'] = array();
		}
		...
		if (isset($this->request->get['api_id'])) {
			$results = $this->model_ortakpanel_api->getApiSessions($this->request->get['api_id']);
	...
	public function addIp() {
		...
		if (!$this->user->hasPermission('modify', 'user/api')) {
			...
			$this->load->model('ortakpanel/api');
			$this->model_ortakpanel_api->addApiIp($this->request->get['api_id'], $this->request->post['ip']);
	...
	public function deleteSession() {
		...
		if (!$this->user->hasPermission('modify', 'user/api')) {
			...
			$this->model_ortakpanel_api->deleteApiSession($this->request->get['api_session_id']);
